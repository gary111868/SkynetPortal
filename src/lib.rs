...
#[derive(Debug)]
pub struct SkynetPortalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SkynetPortalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SkynetPortal processing");
    
    let mut processor = SkynetPortalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SkynetPortalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SkynetPortalProcessor::new(false);
